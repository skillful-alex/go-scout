...
static void main(void) {
  ...
  i1 = 32u;
  i0 += i1;
  (*Z_envZ_eth2_loadPreStateRootZ_vi)(i0);
  i0 = l0;
  i1 = 24u;
  i0 += i1;
  l4 = i0;
  ...
  i64_store((&memory), (u64)(i0), j1);
  i0 = (*Z_envZ_eth2_blockDataSizeZ_iv)();
  if (i0) {goto B0;}
  i0 = l1;
  i1 = l4;
  j1 = i64_load((&memory), (u64)(i1));
  ...
  i1 = 32u;
  i0 += i1;
  (*Z_envZ_eth2_savePostStateRootZ_vi)(i0);
  i0 = l0;
  i1 = 64u;
  i0 += i1;
  g0 = i0;
...
static void init_memory(void) {
  ...
  memcpy(&(memory.data[1048576u]), data_segment_data_0, 12);
}
...
static void init_exports(void) {
  ...
  /* export: 'main' */
  WASM_RT_ADD_PREFIX(Z_mainZ_vv) = (&main);
}
